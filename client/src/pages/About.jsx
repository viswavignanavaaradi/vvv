                ...
                return (
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {data.details.map((item, i) => (
                            <div key={i} className="p-8 text-center bg-white rounded-2xl shadow-sm border border-slate-100 group hover:border-accent-emerald transition-all flex flex-col justify-between items-center">
